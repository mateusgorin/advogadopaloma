...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen relative selection:bg-[#c5a022] selection:text-black">
      <Navbar />
      ...
      <main>
        ...
        <section className="py-24 bg-[#050505] flex justify-center items-center px-6">
          <div className="max-w-5xl text-center scroll-reveal">
            ...
            <div className="h-1 w-20 mx-auto rounded-full shadow-[0_0_15px_rgba(197,160,34,0.5)] animate-gold-beam"></div>
          </div>
        </section>
      ...
      <style>{`
        ...
        @keyframes floatBadge {
          0% { transform: translateY(0px); box-shadow: 0 0 0 rgba(197, 160, 34, 0); }
          50% { transform: translateY(-10px); box-shadow: 0 10px 20px rgba(0, 0, 0, 0.5); }
          100% { transform: translateY(0px); box-shadow: 0 0 0 rgba(197, 160, 34, 0); }
        }
        ...
        .animate-gold-beam {
          background: linear-gradient(90deg, #926d0a 0%, #c5a022 25%, #f4d78a 50%, #c5a022 75%, #926d0a 100%);
